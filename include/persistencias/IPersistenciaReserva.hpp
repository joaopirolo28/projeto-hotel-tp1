 ...
 * pelas Controladoras (Serviços) para acessar dados, suportando a lógica de negócio
...
class IPersistenciaReserva {
    public:
         ...
         * @details Usado para verificar conflito de datas e consistência na exclusão de Quarto.
