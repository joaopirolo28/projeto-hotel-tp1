...
class Endereco{
    ...
    public:
        ...
        * Necessário para a criação de entidades (como Hospede) que contêm este domínio.
        */
        Endereco();
        /**
        * @brief Construtor com valor da classe Endereco.
        * @details Inicializa o objeto com um endereço, que é imediatamente validado.
        * @param valor O endereço a ser definido.
        * @throw invalid_argument Se o endereço não atender aos critérios de validação.
        */
         Endereco(string);
        /**
